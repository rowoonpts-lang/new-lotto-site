...
<div class="wrap clr container">
    <div class="snb" id="snb">
        <div class="imgbox"><a href="http://lottojoongsim.co.kr/landing/2rl1/<?php echo $adcode2_str; ?>" target="_blank"><img src="imgs/ad_1.jpg" alt=""></a></div>
    </div>
    <div class="imgbox banner banner-1"><a href="http://lottojoongsim.co.kr/landing/2robot1/<?php echo $adcode2_str; ?>" target="_blank"><img src="imgs/ad_2.jpg" alt=""></a></div>
    <div class="post">
        <article class="inner">
            ...
            <div class="content-wrap">
                <div class="content">
                    ...
                    <div class="main-latest">
                        ...
                        <ul>
                            <li><a href="http://lotto-js.co.kr/2rl1/<?php echo $adcode2_str; ?>" target="_blank"><img src="imgs/main_latest_1.jpg" alt=""><span>이번주 로또1등 되서 슈퍼카샀다!</span></a></li>
                            <li><a href="http://lotto-js.co.kr/2robot1/<?php echo $adcode2_str; ?>" target="_blank"><img src="imgs/main_latest_2.jpg" alt=""><span>명품女의 사생활 유출되다…충격</span></a></li>
                            <li><a href="http://lotto-js.co.kr/2rl1/<?php echo $adcode2_str; ?>" target="_blank"><img src="imgs/main_latest_3.jpg" alt=""><span>5초만 기다리면 로또1등 번호를 공개합니다!</span></a></li>
                            <li><a href="http://lotto-js.co.kr/2robot1/<?php echo $adcode2_str; ?>" target="_blank"><img src="imgs/main_latest_4.jpg" alt=""><span>사직서 내고 세계여행떠난 여비서의 비밀…</span></a></li>
                        </ul>
                    </div>
