...
<div class="popup-db" id="popup_db">
    ...
    <div class="dbform" id="dbform2">
        ...
        <form name="app_fm2" id="form2" class="form" action="./order_update.php" onsubmit="return fwrite_submit(this);" method="post" autocomplete="off" data-landing="1">
			...
			<input type="hidden" name="lu_type" value="LJ001">
			<input type="hidden" name="lu_code" value="LJ001">
            ...
            <div class="content-wrap">
                <div class="content">
                    ...
                    <div class="dbform" id="dbform">
                        ...
                        <form name="app_fm1" id="form1" class="form" action="./order_update.php" onsubmit="return fwrite_submit(this);" method="post" autocomplete="off" data-landing="1">
							<input type="hidden" name="lu_type" value="LJ001">
							<input type="hidden" name="lu_code" value="LJ001">
                            <div class="item-list">
                                <div class="form-date">
                                ...
                                <div class="item-row">
                                    ...
                                    <div class="field">
                                        <input type="text" class="text required" id="f1" name="name" size="10" required placeholder="이름을 입력하세요…(이름 없이도 신청가능)">
                                    </div>
                                </div>
                                <div class="item-row">
                                    <label for="f2" class="hidden">연락처</label>
                                    <div class="field">
                                        <input type="tel" name="tel" id="f2" required class="text required telcellnum" maxlength="14" placeholder="연락처를 입력하세요…">
                                    </div>
                                </div>
                                <div class="submit">
