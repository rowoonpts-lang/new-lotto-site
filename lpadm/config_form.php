...
<section id="anc_cf_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="cf_url">홈페이지 주소<strong class="sound_only">필수</strong></label></th>
            <td colspan="3"><input type="text" name="cf_url" value="<?php echo get_sanitize_input($config['cf_url']); ?>" id="cf_url"  class=" frm_input" size="40"></td>
        </tr>
        <tr>
...
<section id="anc_cf_sms">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
		<tr>
            <th scope="row"><label for="cf_sms_use">원샷 신번호</label></th>
            <td>
                <input type="text" name="cf_oneshot_tel" value="<?php echo $config['cf_oneshot_tel']; ?>" id="cf_oneshot_tel" class="frm_input" size="20">
            </td>
        </tr>
		<tr>
            <th scope="row"><label for="cf_sms_use">원샷 080번호</label></th>
            <td>
                <input type="text" name="cf_oneshot_080" value="<?php echo $config['cf_oneshot_080']; ?>" id="cf_oneshot_080" class="frm_input" size="20">
            </td>
        </tr>
		<tr>
            <th scope="row"><label for="cf_sms_use">무통장계좌</label></th>
            <td>
				<textarea id="cf_mu_num" name="cf_mu_num"><?=$config['cf_mu_num']?></textarea>
            </td>
        </tr>
        <tr>
