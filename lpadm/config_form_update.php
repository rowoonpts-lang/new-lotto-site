...
sql_query("alter table {$g5['config_table']} add column `cf_oneshot_tel` varchar(50) NOT NULL");
sql_query("alter table {$g5['config_table']} add column `cf_oneshot_080` varchar(50) NOT NULL");
sql_query("alter table {$g5['config_table']} add column `cf_url` varchar(50) NOT NULL");
sql_query("alter table {$g5['config_table']} add column `cf_mu_num` text NOT NULL");
sql_query("alter table {$g5['config_table']} add column `cf_11_subj` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_11` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_12_subj` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_12` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_13_subj` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_13` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_14_subj` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_14` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_15_subj` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_15` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_16_subj` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_16` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_17_subj` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_17` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_18_subj` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_18` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_19_subj` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_19` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_20_subj` varchar(50)");
sql_query("alter table {$g5['config_table']} add column `cf_20` varchar(50)");
...
$sql = " update {$g5['config_table']}
            set cf_title = '{$_POST['cf_title']}',
				...
				cf_oneshot_tel = '{$_POST['cf_oneshot_tel']}',
				cf_oneshot_080 = '{$_POST['cf_oneshot_080']}',
				cf_mu_num = '{$_POST['cf_mu_num']}',
