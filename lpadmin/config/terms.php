...
if (empty($content['co_id'])) {
    alert('이용약관 정보를 찾을 수 없습니다.', G5_LADMIN_URL);
    exit;
}
    ...
    <div class="col-12">
        <div class="card card-primary">
            ...
            <form method="post" action="content.policy.update.php">
                ...
                <input type="hidden" name="co_id" value="provision">
                ...
                <div class="card-footer text-right">
                    <a
                        href="<?=G5_BBS_URL?>/content.php?co_id=provision"
