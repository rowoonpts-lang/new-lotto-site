<?
	...
	$spamList = fnGetSpan();
	$sql_common = " from g5_member a, g5_member_etc b, Msg_Spam c ";
	$sql_search = " where 1=1 and a.mb_id = b.mb_id and a.mb_id != 'admin' and mb_level < 5 and c.Phone_No = a.mb_hp ";
			...
			<div class="card-body table-responsive p-0">
				...
				<tr>
					...
					<td>
						...
						<br>
						<span style="color:red">[080스팸]</span> <span style="color:blue;cursor:pointer" onClick="fnDelSpam('<?=$row['Phone_No']?>')">[해제]</span>
						<?}?>
					</td>
					<td><?=$row['mb_id']?></td>
					<td>
...
<script>
function fnDelSpam(pn){
	if(confirm("해당 스팸을 삭제하시겠습니까?")){
		location.href="./sms.spam.del.php?pn="+pn;
	}
}
