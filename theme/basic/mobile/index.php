	...
	<div class="swiper-container visual_swiper">
		<ul class="swiper-wrapper">
			...
			<li class="swiper-slide visu_li visu_li_2">
				<div class="inner">
					<div class="visu_box">
						<p class="visu_en font_gm_m">Amazing Analysis<br>& Accuracy Grow Rebenue</p>
...
<section class="main_frm_box zindex10">
	<?if(!$is_member){?>
	...
	<div class="inner">
		<div class="mid01_1">
			...
			<div class="mid01_box">
				...
				<img src="<?=G5_THEME_IMG_URL?>/mid01_box_img.png" alt="" style="max-width:100%;">
				...
				<div class="swiper-container review_swiper">
					<ul class="swiper-wrapper">
						...
						<li class="swiper-slide">
							<a href=javascript:// onClick="window.open('<?=$v['ori']?>', '', 'scrollbars=no,resizeable=yes,toolbar=no,status=no');" title=''>
...
<section id="mid02" class="section zindex10">
	<div class="inner">
		...
		<p class="mid02_desc">
			로또피크는 탁월하고 다양한 로또 통계분석 경험을 가진 전문가 집단으로 가장 정확한 분석 처리 능력을 보유하고 있습니다.<br>
			실시간 당첨 피드백과 지속적인 프로그램 업데이트를 통해 높은 당첨 수익률을 보장합니다.
		</p>
		<ul class="mid02_list">
			<li class="mid02_li">
				<a href="">
