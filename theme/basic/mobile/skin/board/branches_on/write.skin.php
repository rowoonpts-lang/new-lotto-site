...
<section id="bo_w">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="wr_4">지도</label></th>
            <td>
                <!--input type="text" name="wr_4" value="<?php echo $write['wr_4'] ?>" id="wr_4" class="frm_input full_input" maxlength="3000"-->
        ...
        <tr>
            ...
            <td>
                <input type="text" name="wr_2" value="<?php echo $write['wr_2'] ?>" id="wr_2" required class="frm_input required" maxlength="255">
            </td>
        </tr>

        <tr>
            <th scope="row"><label for="wr_3">홈페이지</label></th>
            <td>
                <input type="text" name="wr_3" value="<?php echo $write['wr_3'] ?>" id="wr_3" class="frm_input" maxlength="255">
            </td>
        </tr>
