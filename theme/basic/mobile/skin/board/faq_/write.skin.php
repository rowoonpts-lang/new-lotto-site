...
<section id="bo_w">
    ...
    <div class="bo_w_tit write_div">
        ...
        <div id="autosave_wrapper write_div">
			<textarea id="wr_subject" name="wr_subject" placeholder="질문을 입력해 주세요."><?php echo $subject ?></textarea>
        </div>
    </div>
    ...
    <div class="write_div">
        ...
        <div id="autosave_wrapper write_div">
			<textarea  id="wr_content" name="wr_content" placeholder="답변을 입력해 주세요."><?php echo $content ?></textarea>
        </div>
