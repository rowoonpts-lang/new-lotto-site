...
<article id="bo_v">
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        <strong class="if_date"><span class="sound_only">등록일</span><!--<i class="fa fa-clock-o" aria-hidden="true"></i>--> <?php echo date("y-m-d", strtotime($view['wr_datetime'])) ?></strong>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_nb">
            <?php if ($prev_href) { ?><li class="btn_prv"><span class="nb_tit"><i class="fa fa-caret-up" aria-hidden="true"></i> 이전글</span><a href="<?php echo $prev_href ?>"><?php echo conv_subject( $prev_wr_subject,20,'...')?></a> <span class="nb_date"><?php echo str_replace('-', '.', substr($prev_wr_date, '2', '8')); ?></span></li><?php } ?>
            <?php if ($next_href) { ?><li class="btn_next"><span class="nb_tit"><i class="fa fa-caret-down" aria-hidden="true"></i> 다음글</span><a href="<?php echo $next_href ?>"><?php echo conv_subject( $next_wr_subject,20,'...')?></a>  <span class="nb_date"><?php echo str_replace('-', '.', substr($next_wr_date, '2', '8')); ?></span></li><?php } ?>
        </ul>
        <?php } ?>
        <?php
