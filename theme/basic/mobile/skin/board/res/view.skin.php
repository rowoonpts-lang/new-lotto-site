	...
	<li class="res_li1">
		<div class="form_div">
			<ul class="tbl001">
				<li class="sol_li">
					<p>
						<input type="text" value="<?=$view['wr_1']?>" class="form-control requ_box" readonly>
					</p>
				</li>
				<li class="sol_li">
					<p>
						<input type="text" value="<?=$view['wr_2']?>" class="form-control requ_box" readonly>
					</p>
				</li>
				<li class="sol_li">
					<p>
						<input type="text" value="<?=$view['wr_3']?>" class="form-control requ_box" readonly>
					</p>
				</li>
				<li class="sol_li">
					<p>
						<input type="text" value="<?=$view['wr_subject']?>" class="form-control requ_box" readonly>
					</p>
				</li>
				<li class="sol_li">
					<p>
						<textarea  maxlength="" name="wr_content" id="wr_content" class="form-control" readonly><?=$view['wr_content']?></textarea>
					</p>
				</li>
				<li>
					<?
