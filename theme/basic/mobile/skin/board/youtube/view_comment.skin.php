...
<section id="bo_vc">
    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        <header style="z-index:<?php echo $cmt_sv; ?>">
            ...
            <?php } ?>
            <!-- 모바일 작성표시 추가 -->
            <span class="sound_only">모바일체크</span>
            <span class="mobile"><?php //모바일 아이콘 표시
                if (strstr($list[$i]['wr_9'], 'mobile')){
                echo '<img src="'.$board_skin_url.'/img/icon_wifi.png" alt="모바일">';
                }
            ?></span>
            <!-- //모바일 작성표시 추가-->
            <br>
...
<aside id="bo_vc_w" class="bo_vc_w">
    ...
    <!-- 모바일 작성표시 추가 -->
    <?php if(is_mobile()){ ?>
    <input type="hidden" name="wr_9" value="mobile">
    <?php } ?>
    <!-- //모바일 작성표시 추가 -->
