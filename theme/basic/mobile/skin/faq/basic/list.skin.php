...
<ul class="s3_ul">
	...
	<li class="active"><a href="<?=G5_URL?>/bbs/faq.php">자주묻는 질문</a></li>
	<li><a href="<?=G5_URL?>/bbs/qalist.php">1:1 상담</a></li>
</ul>
<div class="s3_tit">자주묻는 질문</div>
<!-- FAQ 시작 { -->
<?php
if ($himg_src)
...
<div id="faq_wrap" class="faq_<?php echo $fm_id; ?>">
    ...
    <section id="faq_con">
        ...
        <ol>
            ...
            <li>
                <h3>
                	<span class="tit_bg">FAQ</span><a href="#none" onclick="return faq_open(this);"><?php echo conv_content($v['fa_subject'], 1); ?></a>
                	<button class="tit_btn" onclick="return faq_open(this);"><img class="faq_arrow" src="<?=G5_THEME_IMG_URL?>/arr_down.png" alt=""><span class="sound_only">열기</span></button>
                </h3>
                <div class="con_inner">
                    <?php echo conv_content($v['fa_content'], 1); ?>
					<span class="tit_bg">답변</span>
                </div>
            </li>
            <?php
            }
...
<?php
if ($admin_href)
    echo '<div class="faq_admin"><a href="/adm_master/faqlist.php?fm_id=1" class="btn_admin btn" title="FAQ 수정">추가하기<span class="sound_only">FAQ 수정</span></a></div>';
?>
...
{	
    ...
    if($con.is(":visible")) {
		...
		//$('.faq_arrow').removeClass('on');
    } else {
        $("#faq_con .con_inner:visible").css("display", "none");
		//$("#faq_con .con_inner:visible").slideUp();
		//$('.faq_arrow').addClass('on');
		$con.slideDown(400);
