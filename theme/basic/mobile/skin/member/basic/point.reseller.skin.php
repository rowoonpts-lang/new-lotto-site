...
add_stylesheet('<link rel="stylesheet" href="'.$member_skin_url.'/reseller_point_style.css">', 0);
?>
<?php
...
<div id="point_wrap" >
    <div class="point_text">
        <p>
            <i class="fa fa-check-circle-o icon_biz_check" aria-hidden="true"></i> 총 누적 수익금 : <span class="my_point"><?php echo $sum_point1; ?>원</span><span class="go_profit_form"><a href="<?=G5_BBS_URL;?>/write.php?bo_table=profit">수익금 신청 +</a></span>수익금은 10,000원 단위로 신청이 가능합니다.  <br>
            <i class="fa fa-check-circle-o icon_biz_check" aria-hidden="true"></i> 신청된 수익금은 시 당일 7~8시에 일괄 입금됩니다.<br>
            <i class="fa fa-check-circle-o icon_biz_check" aria-hidden="true"></i> 500만원 이상 고수익은 피키샵 후기 및 피키샵 홍보컨텐츠에 등록됩니다!<br>
        </p>
    </div>
    ...
    <div class="date_search">
        ...
        <form name="fsearch" id="fsearch" class="local_sch" method="get">
            ...
            <div class="date_sel">
                ...
                <a href="<?=G5_BBS_URL;?>/reseller_point.php" class="btn_submit2">초기화</a>
            </div>
            <p>
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            for ($i=0; $row=sql_fetch_array($result); $i++)
            {
                ...
                <tr >
                    ...
                    <td class="regi_date" ><?=$row['po_inherit_regi_date'];?></td>
                    <td class="pay_date" ><?=$row['po_inherit_pay_date'];?></td>
                </tr>
                <?php
                $num--;
            }
    ...
    <form name="fsearch" id="fsearch" class="local_sch" method="get">
        <input type="hidden" id="fr_date"  name="fr_date" value="<?php echo $fr_date; ?>">
        <input type="hidden" id="to_date"  name="to_date" value="<?php echo $to_date; ?>" >

        <label for="sfl" class="sound_only">검색대상</label>
        <select name="sfl" id="sfl">
            <option value="po_inherit_id"<?php echo get_selected($_GET['sfl'], "po_inherit_id"); ?>>회원아이디</option>
            <option value="po_inherit_name"<?php echo get_selected($_GET['sfl'], "po_inherit_name"); ?>>이름</option>
            <option value="po_point"<?php echo get_selected($_GET['sfl'], "po_point"); ?>>수익금</option>
        </select>
        ...
        <input type="submit" class="btn_submit btn" value="검색">
    </form>
