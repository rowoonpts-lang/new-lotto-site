...
<form id="fregisterform" name="fregisterform" action="<?php echo $register_action_url ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <div id="register_form"  class="form_01">
        <div>
            <h2>PC와 모바일 따로 각각 등록해주세요.<span class="text_required"><i class="icon_required"></i>각 이미지 사이즈에 맞게 업로드 해주세요.</span></h2>
            <ul>
               <span style="display:none">
                ...
                <li>
                    ...
                    <div class="telbox">
                        ...
                        <i class="dashbar"></i>
                        <input type="tel" name="mb_2" id="mb_2" required class="frm_input required nospace" size="10" maxlength="5" value="<?php echo $member['mb_2']?get_text($member['mb_2']):''; ?>" >
                        <i class="dashbar"></i>
                        <input type="tel" name="mb_3" id="mb_3" required class="frm_input required nospace" size="10" maxlength="5" value="<?php echo $member['mb_3']?get_text($member['mb_3']):''; ?>" maxlength="5">
                    </div>
                </li>
                <li>
                ...
                <li>
                    <input type="hidden" name="mb_recommend" value="<?=$recommender;?>">
                    <div class="form_name"><p>피키샵 추천인</p></div>
                    <p class="recommender"><?=$recommender;?></p>
                </li>
                <li>
                ...
                <?php if (isset($member['mb_open_date']) && $member['mb_open_date'] <= date("Y-m-d", G5_SERVER_TIME - ($config['cf_open_modify'] * 86400)) || empty($member['mb_open_date'])) { // 정보공개 수정일이 지났다면 수정가능  ?>
                    <li>
                        ...
                        <div class="form_name "><p class="line2">추천인 공개<br>설정 동의</p></div>
                        <div class="form_agree_q">
                            <p>추천인 회원님에게만 연락처 등을 공개하여 SNS 등으로 피키샵 이용을 돕는 서비스 입니다.</p>
                            <div class="r_agree">
                                <input type="radio" id="mb_open" name="mb_open" value="1" <?php if($member['mb_open'] == '1') {echo "checked"; } ?>/>
                                <label for="mb_open"><span>동의</span></label>

                                <input type="radio" id="mb_open2" name="mb_open" value="0" <?php if($member['mb_open'] == '0') {echo "checked"; } ?>/>
                                <label for="mb_open2"><span>동의 안함</span></label>
                            </div>
                        </div>
                    </li>
                <?php }  ?>
    ...
    <div class="btn_confirm">
        <input type="submit" value="<?php echo $w==''?'무료회원 가입하기':'수정완료'; ?>" id="btn_submit" class="btn_submit" accesskey="s">
    </div>
</form>
