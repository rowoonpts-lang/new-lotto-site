...
?>
<link rel="stylesheet" href="http://175.126.146.142/theme/basic/mobile/skin/qa/basic/style.css">
	    ...
	    <div id="bo_v_top">
	        ...
	        <ul class="bo_v_com">
	        	...
	        	<li>
	        		...
	        		<ul class="more_opt">
	        			<?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn_b01 btn" title="수정">수정</a></li><?php } ?>
	            		<?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn_b01 btn" onclick="del(this.href); return false;" title="삭제">삭제</a></li><?php } ?>
	        		</ul>
	        	</li>
                <?php } ?>
	        </ul>
