    ...
    <form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <tr>
                ...
                <th scope="col">제목</th>
                <th scope="col">글쓴이</th>
                <th scope="col"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?><!--<i class="fa fa-sort" aria-hidden="true"></i>--></a>등록일  </th>
                <th scope="col"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?><!--<i class="fa fa-sort" aria-hidden="true"></i>--></a>조회수 </th>
