...
<section id="bo_w">
    ...
    <ul class="write_ul">
        <li class="bo_w_tit write_div">
            ...
            <div id="autosave_wrapper write_div" class="text_title">
        ...
        <li class="bo_w_flie write_div">
            <span class="op_name">첨부파일</span>
            <div class="file_wr write_div" class="text_title">
    ...
    <div class="write_div">
		...
		<p style="color:red; margin-top: -30px;">썸네일 비율 = 가로: 330px , 세로: 330px, 사진은 파일첨부로 올려주세요(에디터 사용시 사진이 제대로 로드되지 않습니다)</p>
