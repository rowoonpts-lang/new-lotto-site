...
<section id="bo_w">
    ...
    <div class="write_div">
        <label for="wr_subject" class="sound_only">질문<strong>필수</strong></label>
        <div class="write_div wr_content">
			<textarea name="wr_subject" id="wr_subject" required placeholder="질문" style="height:100px;"><?=$write['wr_subject']?></textarea>
        </div>
    </div>

    <div class="write_div">
        <label for="wr_content" class="sound_only">답변<strong>필수</strong></label>
        <div class="write_div wr_content">
			<textarea name="wr_content" id="wr_content" required placeholder="답변" style="height:200px;"><?=$write['wr_content']?></textarea>
        </div>
    </div>
