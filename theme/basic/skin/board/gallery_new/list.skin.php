...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    ...
    <!-- } 게시판 페이지 정보 및 버튼 끝 -->
	 ...
	 <fieldset id="bo_sch">
        ...
        <select name="sfl" id="sfl" class="smart_sel" >
	...
	<div class="sub_mid_banner" >
		<p><a href=""><img src="<?=G5_THEME_IMG_URL?>/sub_mid_banner_img.jpg"></a></p>
	</div>
	<?php if ($is_checkbox) { ?>
    <div id="gall_allchk">
                ...
                <div class="gall_con">
                    ...
                    <div class="gall_text_href">
                        ...
                        <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
							...
							<?php echo conv_subject(strip_tags($list[$i][subject]),15,"...")?>
						 ...
						 <p class="content" ><?php echo conv_subject(strip_tags(str_replace('&nbsp;','',$list[$i][wr_content])),40,"...")?></p>
						 <div class="num_box" >
							<p class="like_btn" ><img src="<?=G5_THEME_IMG_URL?>/like_icon.png"><span><?=number_format($list[$i][wr_hit])?></span></p>
						 </div>
                    </div>
