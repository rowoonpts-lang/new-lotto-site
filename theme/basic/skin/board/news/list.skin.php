    ...
    <form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            for ($i=0; $i<count($list); $i++) {
				$bg_col = "";
				if($list[$i]['ca_name'] == "보도자료"){ $bg_col = "msds_f_1"; }
				if($list[$i]['ca_name'] == "공지"){ $bg_col = "msds_f_2"; }
				if($list[$i]['ca_name'] == "신제품"){ $bg_col = "msds_f_3"; }
				if($list[$i]['ca_name'] == "이벤트"){ $bg_col = "msds_f_4"; }
             ?>
            <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                ...
                if ($list[$i]['is_notice']) // 공지사항
                    echo '<strong class="notice_icon">공지<span class="sound_only">공지</span></strong>';
				...
				<td class="msds_f"> 
					<p class="<?=$bg_col?>"><?=$list[$i]['ca_name']?></p>
                </td>
                ...
                <td class="td_datetime"><?php /*echo $list[$i]['datetime2'] */?><?php echo date("Y-m-d", strtotime($list[$i]['wr_datetime']));?></td>
                <td class="td_num"><span>조회수</span><?php echo $list[$i]['wr_hit'] ?></td>
