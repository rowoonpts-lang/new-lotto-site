...
<section id="bo_w">
	...
	$('#ca_name').on('change', function(){
		...
		if(cate == "보조제" || cate == "마커"){
			if(cate == "보조제"){
				opt += "<option value='아크릴보조제(수성)'>아크릴보조제(수성)</option>";
				opt += "<option value='유화보조제(유성)'>유화보조제(유성)</option>";
				opt += "<option value='한국화보조제(수성)'>한국화보조제(수성)</option>";
			}
			if(cate == "마커"){
				opt += "<option value='디자인마커'>디자인마커</option>";
				opt += "<option value='브러쉬마커'>브러쉬마커</option>";
				opt += "<option value='마커악세사리'>마커악세사리</option>";
			}
			$('#wr_3').append(opt);
			$('#wr_3').css('display','inline-block');
		}
	});

	$('#ca_name').val('<?=$write[ca_name]?>');
	$('#ca_name').change();
	$('#wr_3').val('<?=$write[wr_3]?>');
	</script>
	...
	<div class="bo_w_tit write_div">
		<textarea name="wr_1" id="wr_1" class="frm_input full_input" style="height:150px;"><?=$write['wr_1']?></textarea>
    </div>

	<div class="bo_w_tit write_div">
		<textarea name="wr_2" id="wr_2" class="frm_input full_input" style="height:150px;"><?=$write['wr_2']?></textarea>
    </div>
