...
<div id="login_wrap">
    ...
    <div class="login_left">
        <div id="mb_login" class="mbskin">
            ...
            <?php if ($default['de_level_sell'] == 1) { // 상품구입 권한 ?>
                ...
                <!-- 주문하기, 신청하기 -->
                <?php if (preg_match("/orderform_myshop.php/", $url)) { ?>
                    ...
                    <section id="mb_login_notmb">
                        ...
                        <script>
                            function guest_submit(f)
                            {
                                ...
                                f.url.value = "<?php echo $url; ?>&id=<?=$mb_ids;?>";
                                f.action = "<?php echo $url; ?>&id=<?=$mb_ids;?>";
                                f.submit();
                            }
                        </script>
                    </section>

                <?php } else if (preg_match("/orderinquiry_myshop.php/", $url)) { ?>
                    <div id="mb_login_od_wr">
                        ...
                        <fieldset id="mb_login_od">
                            ...
                            <form name="forderinquiry" method="post" action="<?php echo urldecode($url); ?>?id=<?=$mb_ids;?>" autocomplete="off">
    ...
    <div class="login_right">
        <img src="../../../img/logo.png" alt="피키샵 로고">
        <div class="welcome_text">
            <h2>피키샵 홈페이지에 오신 것을<br>환영합니다!</h2>
            <h3>로그인을 하여 더 다양한 피키샵의<br>혜택을 받으세요~!</h3>
        </div>
