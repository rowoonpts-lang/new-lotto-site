    ...
    <div id="register_form"  class="form_01">
        ...
        <div id="myinfo_top">
            ...
            <div class="t02">
                <ul>
                    <li>
                        <?php if($member['mb_level'] >= '4'){?><a href="/bbs/reseller_point.php"><?php }?>
                        <img src="<?=G5_IMG_URL?>/info_ico1.png" alt="포인트">
                        <p>
                            포인트<br>
                            <span class="<?php if($member['mb_level'] >= '4'){echo"pink";}else{echo"gray";}?> "><?=number_format($my_point);?>원</span>
                        </p>
                        <?php if($member['mb_level'] >= '3'){?></a><?php }?>
                    </li>
                    <li>
                        <?php  if($member['mb_9'] == 'attendance' && $member['mb_8'] >= G5_TIME_YMD){?><a href="<?=G5_URL;?>/attendance/" class="myinfo_btn bt_pink">
                        <?php }else{?><a href="<?=G5_SHOP_URL;?>/attendance.php?it_id=1565925456" class="myinfo_btn bt_pink"><?php }?>
                        <img src="<?=G5_IMG_URL?>/info_ico2.png" alt="출석">
                        <p>출석<br><?php  if($member['mb_9'] == 'attendance' && $member['mb_8'] >= G5_TIME_YMD){?><span class="pink">서비스 중</span><?php }else{?><span class="gray">미신청</span><?php }?></span></p>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div id="myinfo_table">
            ...
            <ul>
                ...
                <li>
                    ...
                    <div class="form_text "><p class="pink">피키샵 <?=get_level_name($member['mb_id']);?> <span class="gray">(리셀러 회원님들에게 드리는 특별한 혜택!)</span><?php   if($member['mb_level'] == '2'){?><a href="<?=G5_SHOP_URL;?>/reseller.php?it_id=1562921863" class="myinfo_btn bt_pink">리셀러 신청하기</a><?php }?></p>
                ...
                <li>
                    ...
                    <div class="form_text">
                        <p>
                            회원님은 피키출석 서비스 <span class="pink">[<?php  if($member['mb_9'] == 'attendance' && $member['mb_8'] >= G5_TIME_YMD){?>서비스 중인<?php }else{?>미신청<?php }?>]</span> 상태입니다.
                            <?php  if($member['mb_9'] == 'attendance' && $member['mb_8'] >= G5_TIME_YMD){?><a href="<?=G5_URL;?>/attendance/" class="myinfo_btn bt_pink">출석현황 보기</a>
                            <?php }else{?><a href="<?=G5_SHOP_URL;?>/attendance.php?it_id=1565925456" class="myinfo_btn bt_pink">서비스 신청하기</a><?php }?>
                        </p>
                    </div>
                </li>
                <?php }?>
                ...
                <?php  if($member['mb_9'] == 'attendance' && $member['mb_8'] >= G5_TIME_YMD){?>
                <li>
