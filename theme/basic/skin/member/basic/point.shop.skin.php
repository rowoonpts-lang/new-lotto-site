...
<div id="point_wrap" >
    <div class="point_text">
        <p>
            <i class="fa fa-check-circle-o icon_biz_check" aria-hidden="true"></i> 총 누적 수익금 : <span class="my_point"><?php echo $sum_point1; ?>원</span><span class="go_profit_form"><a href="<?=G5_BBS_URL;?>/write.php?bo_table=profit2">수익금 신청 +</a></span>수익금은 10,000원 단위로 신청이 가능합니다.  <br>
    ...
    <div class="date_search">
        ...
        <form name="fsearch" id="fsearch" class="local_sch" method="get">
            ...
            <div class="date_sel">
                ...
                <a href="<?=G5_BBS_URL;?>/shop_point.php" class="btn_submit2">초기화</a>
            </div>
            <p>
        ...
        <div class="tbl_head01 tbl_wrap">
            <table>
                ...
                for ($i=0; $row=sql_fetch_array($result); $i++)
                {
                    ...
                    $thessql = "select od_ip,od_receipt_time from g5_shop_order where od_id = '{$row['od_id']}' ";
                    $this_yo = sql_fetch($thessql); // 데이터로 묶음
                    $this_ip = $this_yo['od_ip'];
                    ...
                    <tr >
                        ...
                        <td class="name" ><?php echo date("Y-m-d", strtotime($this_payday)); ?></td>
                        <td class="regi_date" ><?=$this_ip;?></td>
                    </tr>
                    <?php
                    $num--;
                }
    ...
    <form name="fsearch" id="fsearch" class="local_sch" method="get">
        ...
        <select name="sfl" id="sfl">
            <option value="po_content"<?php echo get_selected($_GET['sfl'], "po_content"); ?>>상품명</option>
        </select>
