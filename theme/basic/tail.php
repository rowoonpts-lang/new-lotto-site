		...
		<div class="inner">
			<div class="ft_1_wrap">
				...
				<div class="ft_1_div">
					...
					<div class="ft_1_box">
						<p class="ft_1_txt1">국민 626437-01-005383</p>
						<p class="ft_1_txt2">예금주 : 최화정(디 컴퍼니)</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="ft_2_wrap">
				...
				<div class="ft_info">
					...
					<p class="ft_2_txt ft_addr">
						디 컴퍼니 ㅣ 대표 : 최화정 ㅣ 개인정보책임자 : 최화정 ㅣ 사업자등록번호 : 562-6100552<br>
...
<div class="mbs_pop">
	...
	<form id="frm_2" name="frm_2" method="post">
		<input class="input_tp input_tp1" type="hidden" name="lr_type" id="lr_type_2" value="결제시도">
